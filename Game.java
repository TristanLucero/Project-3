...
public class Game {
    ...
    public boolean PlayerType(int index) {
        Character currChar = Character.playerList.get(index);
        boolean isHuman = false;
        
        if (currChar.getUser() == 1) {
            isHuman = true;
        }
    ...
    public int [] WhoAlive() {
        ...
        for (int i = 0; i < Character.playerList.size(); ++i) {
            if (Character.playerList.get(i).getRole() == 4) {
                alive[3] ++;
            } 
            else if (Character.playerList.get(i).getRole() == 3) {
                alive[2] ++;
            }
            else if (Character.playerList.get(i).getRole() == 2) {
                alive[1] ++;
            }
            else {
                alive[0] ++;
    ...
    //Method that runs through the menus for the human player 
    ...
    //Method that gives applies changes based off what character is active, or
    //what happens when an active characters ability is used 
    ...
    //Method that the AI's use to determine there game strategies 
...
//Main Class -------------------------------------------------------------------
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numPlayers; ++i) {
            if (Character.playerList.get(i).getRole() == 1) {
                currPlayer = i;
                break;
            }
        }
